...
//    val optionalImgUrl = new IconFinderService(domainPattern.findFirstIn(domain.get).get).getBestLogoCandidate().uri
...
//          }
//          catch {
//            case x @ (_ :FileNotFoundException | _: MalformedURLException) => optionalImgUrl
//          }
//        }
//
